  ...
  return (
    <div className="App text-[18px] font-hanken-grotesk grid place-content-center sm:min-h-screen">
      ...
      <section className='grid sm:grid-cols-2 max-w-[700px] sm:shadow-2xl sm:rounded-2xl'>
        ...
        {/* Seccion superior */}
        <section className='bg-gradient-to-t from-light-royal-blue to-light-royal-blue/80 text-center text-white px-10 py-4 rounded-b-3xl sm:rounded-t-3xl sm:grid sm:content-between'>
